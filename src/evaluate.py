#evaluation from 2024 ActionSpotting challenge, https://github.com/SoccerNet/SoccerNet/blob/main/SoccerNet/Evaluation/ActionSpotting.py
#changed 'split' from evaluate function to 'list_games' for custom game evaluation
